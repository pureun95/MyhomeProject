...
<body>
	<div class="wrap">
		...
		<div class="container">
			...
			<form action="/Myhome_project/admin2/notice/deleteok.do" method="POST" id="form1">
							...
							<div class="boardcover">
								<table id="board"
									...
									<c:forEach items="${list}" var="dto">
										<input type="hidden" name ="seq" value="${dto.seqNotice}">
											...
											<td class="sectd boardtd">
												<div class="Boardtdtitle">
													<span class="boardspan headspan"></span> 
														${dto.title}<span class="boardspan footspan"></span>
												</div>
							...
							<div class="boardalert">
								<div class="alert alert-danger" role="alert">
									<span class="glyphicon glyphicon-exclamation-sign"
										aria-hidden="true"></span> <span class="sr-only">경고!</span> 위의
									항목(들)을 삭제하시겠습니까?삭제하시려면 아래의 삭제 버튼을 눌러 주세요.
								</div>
							</div> <!-- 버튼 -->
