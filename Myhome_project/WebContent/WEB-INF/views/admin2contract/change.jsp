				...
				<tr id="navboardtr">
					...
					<td class="navboardtd">
											...
											<table id="adcontracttbl" class="table table-condensed">
												...
												<tr>
													<td class="adcontacttd" colspan="10">
														...
														<div class="low">
															...
															무효·취소 또는 해제되어도 중개보수는 지급한다. 공동중개인 경우에 임대인과 임차인은 자신이 중개 의뢰한
															개업공인중개사에게 각각 중개보수를 지급한다. (중개보수는 거래가액의<span
																class="underline">00%로</span> 한다.) <br> <br> <span
																class="low-title">제 9조 (중개대상물확인·설명서 교부 등)</span>
												...
												<tr>
													<td class="adcontacttd" colspan="10""><textarea
															id="contractcontent" rows="7"
															placeholder="추가 특약 사항을 입력해 주세요.">${dto.content}</textarea>
													</td>
												</tr>
												...
												<tr class="headtr">
													...
													<td class="adcontacttd" colspan="6"><input type="text"
														style="width: 450px;" value="${dto.addT}"></td>
												...
												<tr class="headtr">
													...
													<td class="adcontacttd" colspan="9"><input type="text"
														class="form-control" disabled placeholder="암호를 입력해주세요."></td>
												</tr>
												...
												<tr class="headtr">
													<th class="adcontacttd">계약자명</th>
													<td class="adcontacttd" colspan="3"><input type="text"
														style="width: 200px;" value="${dto.nameL}"></td>
													<th class="adcontacttd" colspan="1">전화번호</th>
													<td class="adcontacttd" colspan="2"><input type="text"
														style="width: 140px;" value="${dto.telL}"></td>
													<th class="adcontacttd">주민번호</th>
													<td class="adcontacttd" colspan="2"><input type="text"
														value="${dto.idNumberL}"></td>
												</tr>
												...
												<tr class="headtr">
													<th class="adcontacttd" colspan="1">주소</th>
													<td class="adcontacttd" colspan="6"><input type="text"
														style="width: 450px;" value="${dto.addL}"></td>
													<th class="adcontacttd" colspan="2">암호입력상태</th>
													<td class="adcontacttd" colspan="1"><input type="text"
														style="width: 80px; background-color: transparent;"
												...
												<tr class="headtr">
													<th class="adcontacttd">계약자명</th>
													<td class="adcontacttd" colspan="3"><input type="text"
														style="width: 200px;" value="${dto.nameC}"></td>
													<th class="adcontacttd" colspan="1">전화번호</th>
													<td class="adcontacttd" colspan="2"><input type="text"
														style="width: 140px;" value="${dto.telC}"></td>
													<th class="adcontacttd">주민번호</th>
													<td class="adcontacttd" colspan="2"><input type="text"
														value="${dto.companyNumberC}"></td>
												</tr>
												...
												<tr class="headtr">
													<th class="adcontacttd" colspan="1">주소</th>
													<td class="adcontacttd" colspan="6"><input type="text"
														style="width: 450px;" value="${dto.addC}"></td>
													<th class="adcontacttd" colspan="2">암호입력상태</th>
													<td class="adcontacttd" colspan="1"><input type="text"
														style="width: 80px; background-color: transparent;"
												...
												<tr>
													<th class="adcontacttd info-color" colspan="10">암호 변경</th>
												</tr>
												
												<tr class="headtr">
													<th class="adcontacttd" colspan="1"><div
															class="vertical-align">암호변경</div></th>
													<td class="adcontacttd" colspan="9">
														<div id="div1">
															<input type="text" name="pass" id="pass" placeholder="영문 또는 숫자 암호만 입력이 가능합니다." maxlength="15">
															<input type="hidden" name="passco" id="passco">
														</div>
													</td>
												</tr>
						...
						<div class="boardbutton">
							...
							<button type="button"
								onclick="location.href='/Myhome-project/admin2/contract/list.do';">목록</button>
						</div>
