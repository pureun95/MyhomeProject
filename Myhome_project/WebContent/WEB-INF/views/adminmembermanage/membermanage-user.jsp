	...
	<div class="boardwrap">
        ...
        <div class="boardcover">
			...
			<div id="member">
                ...
                <tr class="boardtr">
                	<td class="mlist"><input type="checkbox" name="seq" id="seq" value="${dto.seq}"></td>
			...
			<!-- 삭제버튼 -->
			<div class="delete"> 
			<input type="button" id="delete" class="btn" value="선택한 회원 삭제" onclick="location.href='/jsp/project/communitywrite.jsp';">
			</div>
