            ...
            <div id="maintitle">부동산체크리스트</div>
               ...
               <form action="" id="form1">
               		<div class="boardcover">
               			<table id="board" class="table table-hover table-striped table-condensed list">
               				...
               				<tbody>
               					<c:forEach items="${list}" var="dto">
	               					<tr>
	               						<td>${dto.seqCheckList}</td>
	               						<td>
	               						<a href="/Myhome_project/Myhome/user/boardcheckview.do?seq=${dto.seqCheckList}&search=${search}&page=${nowPage}" id="titlename">${dto.title}</a>
	               						<!-- 최신글표시 -->
	               						<c:if test="${dto.gap < 1}">                         
			            ...
			            <form id="searchForm" method="GET" action="/Myhome_project/Myhome/user/boardchecklist.do">
