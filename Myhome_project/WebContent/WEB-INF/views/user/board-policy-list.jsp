...
<body>
	<div class="boardwrap">
         ...
         <div class="container">
            ...
            <div id="maintitle">부동산정책 게시판</div>
               ...
               <form action="" id="form1">
               				...
               				<tbody>
               					...
               					<c:forEach items="${list}" var="dto">
	               					<tr>
	               						<td>${dto.seqPolicy}</td>
	               						<td>
	               						<a href="/Myhome_project/Myhome/user/boardpolicyview.do?seq=${dto.seqPolicy}&search=${search}&page=${nowPage}" id="titlename">${dto.title}</a>
	               						<!-- 최신글표시 -->
	               						<c:if test="${dto.gap < 1}">                         
					...
					<div style="width: 100%;">
						<button type="button" class="btn btn-default" id="basic-addon4"
							onclick="location.href='/Myhome_project/Myhome/user/boardpolicylist.do';">목록</button>
					</div>
					<div style="clear: both;"></div>
					...
					action="/Myhome_project/Myhome/user/boardpolicylist.do">
