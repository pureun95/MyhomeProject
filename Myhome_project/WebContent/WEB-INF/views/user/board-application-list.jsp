            ...
            <div id="maintitle">청약 게시판</div>
               ...
               <form action="" id="form1">
               		<div class="boardcover">
               				...
               				<tbody>
               					<c:forEach items="${list}" var="dto">
	               					<tr>
	               						...
	               						<td>
	               						<a href="/Myhome_project/Myhome/user/boardapplicationview.do?seq=${dto.seqApplication}&search=${search}&page=${nowPage}" id="titlename">${dto.title}</a>
	               						<!-- 최신글표시 -->
	               						<c:if test="${dto.gap < 1}">                         
			            ...
			            <form id="searchForm" method="GET" action="/Myhome_project/Myhome/user/boardapplicationlist.do">
