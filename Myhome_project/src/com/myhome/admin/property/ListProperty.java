	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (n == 1) {
			...
			pagebar += String.format("<li>"
					+ "<a href=\"/Myhome_project/admin/property/listproperty.do?page=%d\" aria-label=\"Previous\">"
					+ "이전"
					+ "</a>"
					+ "</li>", n - 1);
		}
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			pagebar += String.format("<a href=\"/Myhome_project/admin/property/listproperty.do?page=%d\">%d</a></li>", n, n);
