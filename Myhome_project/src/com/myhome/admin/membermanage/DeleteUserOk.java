 ...
 *
 */
@WebServlet("/admin/membermanage/deleteuserok.do")
public class DeleteUserOk extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (result == 1) {
			//글삭제 성공 -> 게시판 목록으로 이동
			resp.sendRedirect("/Myhome_project/admin/membermanage/membermanage-user.do");
