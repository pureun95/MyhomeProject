 ...
 * @author 이대홍
 */
@WebServlet("/admin2/community/list.do")
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (n == 1) {
			pagebar += String.format("<li class='page-item disabled'>"
					+ "<a class='page-link page-a' href=\"/Myhome_project/admin2/community/list.do\">"
					+ "이전</a></li>");
		} else {				
			pagebar += String.format("<li class=\"page-item\">"
					+ "<a class=\"page-link page-a\" "
					+ "href=\"/Myhome_project/admin2/community/list.do?page=%d\">"
					+ "이전</a></li>"
					, n - 1);
		}
...
//<li class="page-item"><a class="page-link page-a" href="">1</a></li>
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			+ " href=\"/Myhome_project/admin2/community/list.do?page=%d\">%d</a></li>", n, n);
...
//<li><a class="page-link page-a" href="">다음</a></li>
		...
		*/ 
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/admin2community/list.jsp");
