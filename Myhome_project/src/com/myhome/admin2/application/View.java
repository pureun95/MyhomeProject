...
/**
 * 청약 게시글 1개의 내용 반환 서블릿
 * @author 이대홍
 */
@WebServlet("/admin2/application/view.do")
 ...
 */
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/admin2application/view.jsp");
