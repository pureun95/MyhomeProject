...
@WebServlet("/contractor/mypage-contract-insert.do")
public class ContractInsert extends HttpServlet{

	//http://localhost:8090/Myhome_project/contractor/mypage-contract-insert.do
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 req.getRequestDispatcher("/WEB-INF/views/contractor/mypage-contract-insert.jsp");
