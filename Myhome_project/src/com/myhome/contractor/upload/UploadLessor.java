	...
	//2. session 받기
		...
		if ( n == 1 ) {
			...
			pagebar += String.format("<li>"
										+ "            <a href=\"/Myhome_project/contractor/search-contractor.do?page=%d\" aria-label=\"Previous\">"
										+ "                <span aria-hidden=\"true\">&laquo;</span>"
										+ "            </a>"
										+ "        </li>", n - 1);
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			if (nowPage == n) {
				...
				pagebar += String.format("<a href=\"/Myhome_project/contractor/search-contractor.do?page=%d\">%d</a></li>", n, n);
			...
			if (n > totalPage) { 
				...
				pagebar += String.format("<li>"
										+ "            <a href=\"/Myhome_project/contractor/search-contractor.do?page=%d\" aria-label=\"Next\">"
										+ "                <span aria-hidden=\"true\">&raquo;</span>"
										+ "            </a>"
										+ "        </li>", n);
			}
			...
			RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/contractor/upload-lessor.jsp");
